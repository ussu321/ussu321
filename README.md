...
<svg width="100%" height="240" viewBox="0 0 800 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect width="800" height="240" fill="#0d1117" rx="20" stroke="#00d4ff" stroke-width="2"/>

  <!-- Animated circuit lines -->
  <path d="M50,200 L100,200 L100,150 L150,150" fill="none" stroke="#00d4ff" stroke-width="1.5" opacity="0.4">
    <animate attributeName="stroke-dasharray" values="0,200;200,0" dur="3s" repeatCount="indefinite"/>
  </path>
  <path d="M750,200 L700,200 L700,150 L650,150" fill="none" stroke="#7c3aed" stroke-width="1.5" opacity="0.4">
    <animate attributeName="stroke-dasharray" values="0,200;200,0" dur="3s" begin="1.5s" repeatCount="indefinite"/>
  </path>
  <circle cx="150" cy="150" r="3" fill="#00d4ff" opacity="0.6">
    <animate attributeName="opacity" values="0.6;0;0.6" dur="2s" repeatCount="indefinite"/>
  </circle>
  <circle cx="650" cy="150" r="3" fill="#7c3aed" opacity="0.6">
    <animate attributeName="opacity" values="0.6;0;0.6" dur="2s" begin="1s" repeatCount="indefinite"/>
  </circle>

  <!-- Floating particles -->
  <circle cx="80" cy="60" r="2" fill="#00d4ff" opacity="0.5">
  ...
  <circle cx="720" cy="180" r="2" fill="#7c3aed" opacity="0.5">
    <animate attributeName="cy" values="180;50;180" dur="7s" repeatCount="indefinite"/>
    <animate attributeName="opacity" values="0.5;0;0.5" dur="7s" repeatCount="indefinite"/>
  </circle>
  <circle cx="250" cy="40" r="1.5" fill="#00ff88" opacity="0.4">
    <animate attributeName="cy" values="40;190;40" dur="8s" repeatCount="indefinite"/>
    <animate attributeName="cx" values="250;450;250" dur="8s" repeatCount="indefinite"/>
  </circle>

  <!-- Neural network nodes -->
  <g filter="url(#softGlow)">
    <circle cx="180" cy="100" r="4" fill="#00d4ff" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" repeatCount="indefinite"/>
    </circle>
    <circle cx="180" cy="130" r="4" fill="#00d4ff" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" begin="0.3s" repeatCount="indefinite"/>
    </circle>
    <circle cx="220" cy="115" r="4" fill="#7c3aed" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" begin="0.6s" repeatCount="indefinite"/>
    </circle>
    <line x1="180" y1="100" x2="220" y2="115" stroke="#00d4ff" stroke-width="1" opacity="0.5"/>
    <line x1="180" y1="130" x2="220" y2="115" stroke="#00d4ff" stroke-width="1" opacity="0.5"/>
  </g>

  <g filter="url(#softGlow)">
    <circle cx="620" cy="100" r="4" fill="#7c3aed" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" begin="0.5s" repeatCount="indefinite"/>
    </circle>
    <circle cx="620" cy="130" r="4" fill="#7c3aed" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" begin="0.8s" repeatCount="indefinite"/>
    </circle>
    <circle cx="580" cy="115" r="4" fill="#00ff88" opacity="0.8">
      <animate attributeName="r" values="4;6;4" dur="2s" begin="1.1s" repeatCount="indefinite"/>
    </circle>
    <line x1="620" y1="100" x2="580" y2="115" stroke="#7c3aed" stroke-width="1" opacity="0.5"/>
    <line x1="620" y1="130" x2="580" y2="115" stroke="#7c3aed" stroke-width="1" opacity="0.5"/>
  </g>

  <!-- Main Title -->
  <text x="400" y="100" font-family="monospace" font-size="46" font-weight="bold" fill="#e6edf3" text-anchor="middle" filter="url(#aiGlow)">
    U S S U  3 2 1
  </text>
  ...
  <line x1="180" y1="175" x2="620" y2="175" stroke="url(#aiGrad)" stroke-width="2.5" stroke-linecap="round">
  ...
  <!-- Terminal status -->
  <text x="400" y="205" font-family="monospace" font-size="12" fill="#00d4ff" text-anchor="middle">
    <tspan>[</tspan><tspan fill="#7c3aed">root@ussu321</tspan><tspan>]</tspan><tspan fill="#e6edf3"> ~ $ python3 automate_the_future.py</tspan>
    <animate attributeName="opacity" values="1;0.3;1" dur="1.5s" repeatCount="indefinite"/>
  </text>

  <!-- Animated dots -->
  <circle cx="360" cy="225" r="3" fill="#00d4ff">
    <animate attributeName="opacity" values="0;1;0" dur="1.2s" repeatCount="indefinite"/>
  </circle>
  <circle cx="400" cy="225" r="3" fill="#7c3aed">
    <animate attributeName="opacity" values="0;1;0" dur="1.2s" begin="0.4s" repeatCount="indefinite"/>
  </circle>
  <circle cx="440" cy="225" r="3" fill="#00ff88">
...
<p>
  ...
  <code><img height="30" src="https://raw.githubusercontent.com/github/explore/main/topics/pandas/pandas.png" alt="pandas"></code>
  ...
  <code><img height="30" src="https://raw.githubusercontent.com/github/explore/main/topics/artificial-intelligence/artificial-intelligence.png" alt="ai"></code>
</p>
...
## 📊 GitHub Stats & Neural Activity

<div align="center">

<!-- GitHub Stats -->
<img src="https://github-readme-stats.vercel.app/api?username=ussu321&show_icons=true&theme=radical&hide_border=true&bg_color=0d1117&title_color=00d4ff&icon_color=7c3aed&text_color=e6edf3&ring_color=00d4ff&fire_color=7c3aed" width="49%" />
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=ussu321&layout=compact&theme=radical&hide_border=true&bg_color=0d1117&title_color=00d4ff&icon_color=7c3aed&text_color=e6edf3" width="49%" />
...
<!-- Trophy Case -->
<img src="https://github-profile-trophy.vercel.app/?username=ussu321&theme=radical&no-frame=true&no-bg=true&margin-w=15&margin-h=15&column=7" width="100%" />
...
<!-- Activity Graph -->
<img src="https://github-readme-activity-graph.vercel.app/graph?username=ussu321&theme=react-dark&hide_border=true&bg_color=0d1117&color=00d4ff&line=7c3aed&point=e6edf3&area=true&area_color=00d4ff" width="100%" />
